...
| Progress | `api.my_activity_progress`, `api.my_hub_activity_progress` | No |
...
| **Progress** | What does that mean for the journey? | Derived views (`api.my_activity_progress`, hub-scoped `api.my_hub_activity_progress`), not a write model |
